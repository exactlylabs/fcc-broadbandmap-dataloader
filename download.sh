...
export FILE_ID_LIST=$(curl https://broadbandmap.fcc.gov/nbm/map/api/national_map_process/nbm_get_data_download/$NBM_PROCESS_ID | jq '.data[] | select(.data_type=="Fixed Broadband") | .id')
